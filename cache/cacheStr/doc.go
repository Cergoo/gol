...
/*
Package cacheStr it's a in-memory key-value store based of the thread-safe hasmap implementation (key type string) similar to memcached that is suitable for applications running on a single machine.
